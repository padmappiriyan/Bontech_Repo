...
const DailyDrawerReconciliation = ({ isFinalized, isNotStarted }) => {
    ...
    const loadData = async () => {
        try {
            ...
            if (status.data) {
                ...
                setFormData({
                    actualClosing: status.data.actualClosing || 0,
                    cbAmount: status.data.cbAmount || 0,
                    depositAmount: status.data.depositAmount || 0,
                    creditAmount: status.data.creditAmount || 0
                });
            }
    ...
    const calculatedBalance = isSavedLocally ? 0 : (formData.actualClosing + formData.depositAmount - formData.creditAmount);
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-10 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl font-bold text-slate-700 outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all ${(!isFinalized || isSavedLocally) ? 'opacity-50 cursor-not-allowed' : ''}`}
