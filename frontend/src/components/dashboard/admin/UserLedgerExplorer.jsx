                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-neutral-50/50">
                                            <th className="py-5 pl-8 pr-3 text-[10px] font-black text-neutral-400 uppercase tracking-widest">Date</th>
                                            <th className="py-5 px-3 text-[10px] font-black text-neutral-400 uppercase tracking-widest">B/F</th>
                                            <th className="py-5 px-3 text-[10px] font-black text-neutral-400 uppercase tracking-widest">Send</th>
                                            <th className="py-5 px-3 text-[10px] font-black text-neutral-400 uppercase tracking-widest">Paid</th>
                                            <th className="py-5 px-3 text-[10px] font-black text-neutral-400 uppercase tracking-widest">Deposit</th>
                                            <th className="py-5 pr-8 pl-3 text-[10px] font-black text-neutral-900 uppercase tracking-widest text-right">Balance</th>
                                        </tr>
                                    </thead>
                                        ...
                                        {activeData.length === 0 && (
                                            <tr>
                                                <td colSpan={6} className="py-16 text-center">
                                                    <p className="text-sm font-medium text-slate-400">No ledger entries exist for the selected period.</p>
                                                </td>
                                            </tr>
                                        )}
                                    </tbody>
